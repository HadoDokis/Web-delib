...
class TypeseancesController extends AppController {
    ...
    function admin_edit($id = null) {
        ...
        if($this->request->is('Post')){
            ...
            if ($this->Typeseance->save($this->data)) {
                ...
                if (array_key_exists('Typeacteur', $this->data)) {
                    ...
                    $this->set('selectedTypeActes', $this->data['Typeacte']['Typeacte']);
                } else {
                    $this->set('selectedTypeacteurs', null);
                    $this->set('selectedActeurs', null);
                }
        ...
        {
            $this->data = $this->Typeseance->find('first', array(
                'conditions' => array('Typeseance.id' => $id),
                'contain' => array(
            ...
            if (empty($this->data)) {
                ...
                $this->set('selectedTypeActes', $this->_selectedArray($this->data['Typeacte']));
            }
        }
