 ...
 */
	public function btn($text, $url = array(), $options = array(), $confirmMessage = false) {
         ...
         */
	public function tab($titles, $options = array()) {
            ...
            $out ='<!-- Nav tabs -->';
            $out .=$this->tag('ul', null,array('id'=>$options['id'], 'class'=> $class, 'role'=>'tablist'));
            foreach ($titles as $key => $title) {
                $out .=$this->tag('li', null, (!empty($options['active']) && $options['active']==$key?array('class'=>'active'):array()));
                $out .=$this->link($title, '#'.$key, array('role'=>'tab','data-toggle'=>'tab'));
        ...
        public function tabContent($options = array()) {
            return '<!-- Tab panes -->'.parent::div('tab-content');
        }
        public function tabPane($title, $options = array()) {
            $class='tab-pane';
            if (!empty($options['class'])) {
		if(is_array($options['class']))
                foreach ($class as $opt) {
            ...
            return '<!-- Panes -->'.parent::div($class, null, array('id'=>$title));
        }
