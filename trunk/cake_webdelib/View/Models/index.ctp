...
<tr height="36px">
	...
	<td class="actions">
	    ...
	    <?php echo $this->Html->link(SHY,'/models/edit/' . $model['Model']['id'], array('class'=>'link_modifier', 'escape' => false, 'title'=>'Modifier'), false); ?>
	    <?php
            if ($model['Model']['id'] != 1 && $deletable[$model['Model']['id']])
