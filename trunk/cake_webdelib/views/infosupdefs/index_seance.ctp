...
<ul class="actions">
	<?php echo $html->link('Ajouter une information suppl&eacute;mentaire', '/infosupdefs/add/Seance', array('class'=>'link_add', 'title'=>'Ajouter une information supplémentaire'), false, false); ?>
</ul>
