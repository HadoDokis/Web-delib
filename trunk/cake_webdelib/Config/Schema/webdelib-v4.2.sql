...
SELECT pg_catalog.setval('acteurs_id_seq', 5, true);
...
SELECT pg_catalog.setval('acteurs_seances_id_seq', 3, true);
...
SELECT pg_catalog.setval('ados_id_seq', 5, true);
...
SELECT pg_catalog.setval('annexes_id_seq', 99, true);
...
SELECT pg_catalog.setval('aros_ados_id_seq', 12, true);
...
SELECT pg_catalog.setval('circuits_users_id_seq', 30, true);
...
SELECT pg_catalog.setval('commentaires_id_seq', 23, true);
...
INSERT INTO compteurs (id, nom, commentaire, def_compteur, sequence_id, def_reinit, val_reinit, created, modified) VALUES (4, 'Arrêtés', '', '#AAAA#_#000#', 4, '#AAAA#', NULL, '2014-03-14 16:34:10', '2014-03-14 16:34:10');
...
SELECT pg_catalog.setval('compteurs_id_seq', 4, true);
...
SELECT pg_catalog.setval('deliberations_id_seq', 92, true);
...
SELECT pg_catalog.setval('deliberations_seances_id_seq', 96, true);
...
SELECT pg_catalog.setval('deliberations_typeseances_id_seq', 324, true);
...
SELECT pg_catalog.setval('historiques_id_seq', 317, true);
...
SELECT pg_catalog.setval('infosupdefs_id_seq', 6, true);
...
SELECT pg_catalog.setval('infosupdefs_profils_id_seq', 15, true);
...
SELECT pg_catalog.setval('infosuplistedefs_id_seq', 6, true);
...
SELECT pg_catalog.setval('infosups_id_seq', 174, true);
...
SELECT pg_catalog.setval('listepresences_id_seq', 125, true);
...
SELECT pg_catalog.setval('modeltemplates_id_seq', 11, true);
...
SELECT pg_catalog.setval('modelvalidations_id_seq', 1273, true);
...
SELECT pg_catalog.setval('profils_id_seq', 4, true);
...
SELECT pg_catalog.setval('seances_id_seq', 20, true);
...
INSERT INTO sequences (id, nom, commentaire, num_sequence, created, modified) VALUES (4, 'Arrêtés', '', 0, '2014-03-14 16:33:08', '2014-03-14 16:33:08');
...
SELECT pg_catalog.setval('sequences_id_seq', 4, true);
...
SELECT pg_catalog.setval('typeactes_id_seq', 6, true);
...
SELECT pg_catalog.setval('typeacteurs_id_seq', 2, true);
...
SELECT pg_catalog.setval('typeseances_id_seq', 2, true);
...
SELECT pg_catalog.setval('typeseances_natures_id_seq', 3, true);
...
SELECT pg_catalog.setval('typeseances_typeacteurs_id_seq', 3, true);
...
INSERT INTO users_services (id, user_id, service_id) VALUES (37, 1, 1);
...
SELECT pg_catalog.setval('users_services_id_seq', 37, true);
...
SELECT pg_catalog.setval('wkf_compositions_id_seq', 7, true);
...
SELECT pg_catalog.setval('wkf_traitements_id_seq', 35, true);
...
SELECT pg_catalog.setval('wkf_visas_id_seq', 200, true);
