...
ALTER TABLE ONLY public.wkf_visas DROP CONSTRAINT wkf_visas_etape_id_fkey;
ALTER TABLE ONLY public.wkf_signatures DROP CONSTRAINT wkf_signatures_visa_id_fkey;
ALTER TABLE ONLY public.modelvalidations DROP CONSTRAINT modelvalidations_modelvariable_id_fkey;
ALTER TABLE ONLY public.modelvalidations DROP CONSTRAINT modelvalidations_modeltype_id_fkey;
ALTER TABLE ONLY public.modelvalidations DROP CONSTRAINT modelvalidations_modelsection_id_fkey;
ALTER TABLE ONLY public.modeltemplates DROP CONSTRAINT modeltemplates_modeltype_id_fkey;
ALTER TABLE ONLY public.modelsections DROP CONSTRAINT modelsections_parent_id_fkey;
DROP INDEX public.wkf_visas_traitements;
DROP INDEX public.users_services_users;
DROP INDEX public.user_id;
DROP INDEX public."user";
DROP INDEX public.typeseancenature_nature;
DROP INDEX public.typeseance_id;
DROP INDEX public.typeacteur;
DROP INDEX public.type_id;
DROP INDEX public.trigger;
DROP INDEX public.traitements_treated;
DROP INDEX public.themes_left;
DROP INDEX public.theme_id;
DROP INDEX public.text;
DROP INDEX public.tdtmsg_;
DROP INDEX public.target;
DROP INDEX public.suppleant_id;
DROP INDEX public.service_id;
DROP INDEX public.seances_traitee;
DROP INDEX public.seances_id;
DROP INDEX public.rght;
DROP INDEX public.redacteur_id;
DROP INDEX public.rapporteur_id;
DROP INDEX public.parent_id;
DROP INDEX public.parent;
DROP INDEX public.nom;
DROP INDEX public.nature_id;
DROP INDEX public.modified_user_id;
DROP INDEX public.model_foreign_key;
DROP INDEX public.model;
DROP INDEX public.login;
DROP INDEX public.lft;
DROP INDEX public.infosupdef_id;
DROP INDEX public.index;
DROP INDEX public.foreign_key;
DROP INDEX public.etat;
DROP INDEX public.etape_id;
DROP INDEX public.elu;
DROP INDEX public.deliberations_seances_seance;
DROP INDEX public.deliberations_id;
DROP INDEX public.deliberation_id;
DROP INDEX public.created_user_id;
DROP INDEX public.circuits;
DROP INDEX public.circuit_id;
DROP INDEX public.aros_leftright;
DROP INDEX public.aros_idx3;
DROP INDEX public.aros_idx2;
DROP INDEX public.aros_idx1;
DROP INDEX public.aro_id;
DROP INDEX public.annexes_joindre;
DROP INDEX public.alias_2;
DROP INDEX public.alias;
DROP INDEX public.ado_id;
DROP INDEX public.acteursservices_service_id;
DROP INDEX public.acteursservices_acteur_id;
DROP INDEX public.acteurs_actif;
DROP INDEX public.acteur_id;
DROP INDEX public.acos_leftright;
DROP INDEX public.acos_idx3;
DROP INDEX public.acos_idx2;
DROP INDEX public.acos_idx1;
DROP INDEX public.aco_id;
DROP INDEX public."INFOSUPDEF_ID_ORDRE";
ALTER TABLE ONLY public.wkf_visas DROP CONSTRAINT wkf_visas_pkey;
ALTER TABLE ONLY public.wkf_traitements DROP CONSTRAINT wkf_traitements_pkey;
ALTER TABLE ONLY public.wkf_signatures DROP CONSTRAINT wkf_signatures_pkey;
ALTER TABLE ONLY public.wkf_etapes DROP CONSTRAINT wkf_etapes_pkey;
ALTER TABLE ONLY public.wkf_compositions DROP CONSTRAINT wkf_compositions_pkey;
ALTER TABLE ONLY public.wkf_circuits DROP CONSTRAINT wkf_circuits_pkey;
ALTER TABLE ONLY public.votes DROP CONSTRAINT votes_pkey;
ALTER TABLE ONLY public.users_services DROP CONSTRAINT users_services_pkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.typeseances_typeacteurs DROP CONSTRAINT typeseances_typeacteurs_pkey;
ALTER TABLE ONLY public.typeseances DROP CONSTRAINT typeseances_pkey;
ALTER TABLE ONLY public.typeseances_typeactes DROP CONSTRAINT typeseances_natures_pkey;
ALTER TABLE ONLY public.typeseances_acteurs DROP CONSTRAINT typeseances_acteurs_pkey;
ALTER TABLE ONLY public.typeacteurs DROP CONSTRAINT typeacteurs_pkey;
ALTER TABLE ONLY public.typeactes DROP CONSTRAINT typeactes_id_key;
ALTER TABLE ONLY public.traitements DROP CONSTRAINT traitements_pkey;
ALTER TABLE ONLY public.themes DROP CONSTRAINT themes_pkey;
ALTER TABLE ONLY public.tdt_messages DROP CONSTRAINT tdt_messages_pkey;
...
ALTER TABLE ONLY public.profils DROP CONSTRAINT profils_pkey;
ALTER TABLE ONLY public.nomenclatures DROP CONSTRAINT nomenclatures_pkey;
ALTER TABLE ONLY public.natures DROP CONSTRAINT natures_pkey;
ALTER TABLE ONLY public.modelvariables DROP CONSTRAINT modelvariables_pkey;
ALTER TABLE ONLY public.modelvalidations DROP CONSTRAINT modelvalidations_pkey;
ALTER TABLE ONLY public.modeltypes DROP CONSTRAINT modeltypes_pkey;
ALTER TABLE ONLY public.modelsections DROP CONSTRAINT modelsections_pkey;
ALTER TABLE ONLY public.modeltemplates DROP CONSTRAINT models_pkey;
ALTER TABLE ONLY public.listepresences DROP CONSTRAINT listepresences_pkey;
ALTER TABLE ONLY public.infosups DROP CONSTRAINT infosups_pkey;
ALTER TABLE ONLY public.infosuplistedefs DROP CONSTRAINT infosuplistedefs_pkey;
ALTER TABLE ONLY public.infosupdefs DROP CONSTRAINT infosupdefs_pkey;
ALTER TABLE ONLY public.historiques DROP CONSTRAINT historiques_pkey;
ALTER TABLE ONLY public.deliberations_typeseances DROP CONSTRAINT deliberations_typeseances_pkey;
ALTER TABLE ONLY public.deliberations_seances DROP CONSTRAINT deliberations_seances_pkey;
ALTER TABLE ONLY public.deliberations DROP CONSTRAINT deliberations_pkey;
ALTER TABLE ONLY public.crons DROP CONSTRAINT crons_pkey;
ALTER TABLE ONLY public.compteurs DROP CONSTRAINT compteurs_pkey;
ALTER TABLE ONLY public.commentaires DROP CONSTRAINT commentaires_pkey;
ALTER TABLE ONLY public.collectivites DROP CONSTRAINT collectivites_pkey;
ALTER TABLE ONLY public.circuits_users DROP CONSTRAINT circuits_users_pkey;
ALTER TABLE ONLY public.aros DROP CONSTRAINT aros_pkey;
ALTER TABLE ONLY public.aros_ados DROP CONSTRAINT aros_ados_pkey;
ALTER TABLE ONLY public.aros_acos DROP CONSTRAINT aros_acos_pkey;
ALTER TABLE ONLY public.annexes DROP CONSTRAINT annexes_pkey;
ALTER TABLE ONLY public.ados DROP CONSTRAINT ados_pkey;
ALTER TABLE ONLY public.acteurs_services DROP CONSTRAINT acteurs_services_pkey;
ALTER TABLE ONLY public.acteurs_seances DROP CONSTRAINT acteurs_seances_pkey;
ALTER TABLE ONLY public.acteurs DROP CONSTRAINT acteurs_pkey;
ALTER TABLE ONLY public.acos DROP CONSTRAINT acos_pkey;
ALTER TABLE public.typeactes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.modelvariables ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.modelvalidations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.modeltypes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.modeltemplates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.modelsections ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.infosupdefs_profils ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.deliberations_typeseances ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.crons ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.acteurs_seances ALTER COLUMN id DROP DEFAULT;
DROP TABLE public.wkf_visas;
DROP SEQUENCE public.wkf_visas_id_seq;
DROP TABLE public.wkf_traitements;
DROP SEQUENCE public.wkf_traitements_id_seq;
DROP TABLE public.wkf_signatures;
DROP SEQUENCE public.wkf_signatures_id_seq;
DROP TABLE public.wkf_etapes;
DROP SEQUENCE public.wkf_etapes_id_seq;
DROP TABLE public.wkf_compositions;
DROP SEQUENCE public.wkf_compositions_id_seq;
DROP TABLE public.wkf_circuits;
DROP SEQUENCE public.wkf_circuits_id_seq;
DROP TABLE public.votes;
DROP SEQUENCE public.votes_id_seq;
DROP TABLE public.users_services;
DROP SEQUENCE public.users_services_id_seq;
DROP TABLE public.users;
DROP SEQUENCE public.users_id_seq;
DROP TABLE public.typeseances_typeacteurs;
DROP SEQUENCE public.typeseances_typeacteurs_id_seq;
DROP TABLE public.typeseances_typeactes;
DROP SEQUENCE public.typeseances_natures_id_seq;
DROP TABLE public.typeseances_acteurs;
DROP SEQUENCE public.typeseances_acteurs_id_seq;
DROP TABLE public.typeseances;
DROP SEQUENCE public.typeseances_id_seq;
DROP TABLE public.typeacteurs;
DROP SEQUENCE public.typeacteurs_id_seq;
DROP SEQUENCE public.typeactes_id_seq;
DROP TABLE public.typeactes;
DROP TABLE public.traitements;
DROP SEQUENCE public.traitements_id_seq;
DROP TABLE public.themes;
DROP SEQUENCE public.themes_id_seq;
DROP TABLE public.tdt_messages;
DROP SEQUENCE public.tdt_messages_id_seq;
DROP TABLE public.services;
DROP SEQUENCE public.services_id_seq;
DROP TABLE public.sequences;
DROP SEQUENCE public.sequences_id_seq;
DROP TABLE public.seances;
DROP SEQUENCE public.seances_id_seq;
...
DROP SEQUENCE public.modelvariables_id_seq;
DROP TABLE public.modelvariables;
DROP SEQUENCE public.modelvalidations_id_seq;
DROP TABLE public.modelvalidations;
DROP SEQUENCE public.modeltypes_id_seq;
DROP TABLE public.modeltypes;
DROP SEQUENCE public.modeltemplates_id_seq;
DROP TABLE public.modeltemplates;
DROP SEQUENCE public.modelsections_id_seq;
DROP TABLE public.modelsections;
DROP TABLE public.listepresences;
DROP SEQUENCE public.listepresences_id_seq;
DROP TABLE public.infosups;
DROP SEQUENCE public.infosups_id_seq;
DROP TABLE public.infosuplistedefs;
DROP SEQUENCE public.infosuplistedefs_id_seq;
DROP SEQUENCE public.infosupdefs_profils_id_seq;
DROP TABLE public.infosupdefs_profils;
DROP TABLE public.infosupdefs;
DROP SEQUENCE public.infosupdefs_id_seq;
DROP TABLE public.historiques;
DROP SEQUENCE public.historiques_id_seq;
DROP SEQUENCE public.deliberations_typeseances_id_seq;
DROP TABLE public.deliberations_typeseances;
DROP TABLE public.deliberations_seances;
DROP SEQUENCE public.deliberations_seances_id_seq;
DROP TABLE public.deliberations;
DROP SEQUENCE public.deliberations_id_seq;
DROP SEQUENCE public.crons_id_seq;
DROP TABLE public.crons;
DROP TABLE public.compteurs;
DROP SEQUENCE public.compteurs_id_seq;
...
DROP SEQUENCE public.circuits_users_id_seq;
DROP TABLE public.aros_ados;
DROP SEQUENCE public.aros_ados_id_seq;
...
DROP SEQUENCE public.annexes_id_seq;
DROP TABLE public.ados;
DROP SEQUENCE public.ados_id_seq;
DROP TABLE public.acteurs_services;
DROP SEQUENCE public.acteurs_services_id_seq;
DROP SEQUENCE public.acteurs_seances_id_seq;
DROP TABLE public.acteurs_seances;
DROP TABLE public.acteurs;
DROP SEQUENCE public.acteurs_id_seq;
...
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (1, 'Circuits de traitement : Mise à jour des traitements extérieurs', 'Lecture de l''état des traitements extérieurs (iParapheur)', NULL, 'delegationJob', false, NULL, '2014-02-19 14:50:55.790597', 'PT1H', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', '', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 2, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (2, 'Circuits de traitement : Déclenchement des alertes de retard', 'Relance les utilisateurs devant valider un projet en retard', NULL, 'retardCakeflowJob', false, NULL, '2014-02-19 14:50:55.790597', 'P1D', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (3, 'Signature : Mise à jour de l''etat des dossiers envoyés au Parapheur', 'Met à jour l''état des projets envoyés au Parapheur pour signature et rapatrie les informations de ceux en fin de circuit.', NULL, 'signatureJob', false, NULL, '2014-02-19 14:50:55.790597', 'P1D', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (4, 'TDT : Mise à jours des mails sécurisés', 'Envoi/Réception des mails sécurisés', NULL, 'mailSecJob', false, NULL, '2014-02-19 14:50:55.790597', 'PT5M', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (5, 'TDT : Mise à jour des accusés de réception', 'Vérifie la réception par la prefecture des dossiers envoyés via le TDT et dans le cas échéant, enregistre la date de l''accusé de réception et le bordereau', NULL, 'majArTdt', false, NULL, '2014-02-19 14:50:55.790597', 'PT5M', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (6, 'TDT : Mise à jour des échanges de courriers', 'Met à jour les échanges de courriers entre la préfecture et le TDT', NULL, 'majCourriersTdt', false, NULL, '2014-02-19 14:50:55.790597', 'P1D', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
INSERT INTO crons (id, nom, description, plugin, action, has_params, params, next_execution_time, execution_duration, last_execution_start_time, last_execution_end_time, last_execution_report, last_execution_status, active, created, created_user_id, modified, modified_user_id, model, lock) VALUES (7, 'CONVERTION : convertion des annexes', 'convertion des annexes dans différents formats', NULL, 'convertionAnnexesJob', false, NULL, '2014-02-19 14:50:55.790597', 'P1D', '2014-02-19 14:50:55.790597', '2014-02-19 14:50:55.790597', 'Cette tâche n''a encore jamais été exécutée.', NULL, true, '2014-02-19 14:50:55.790597', 1, '2014-02-19 14:50:55.790597', 1, 'CronJob', false);
