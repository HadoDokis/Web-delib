...
class Odf
{
     ...
     * @return odf
     */
    public function setImage($key, $value, $index)
    {
        ...
        $xml = <<<IMG
<draw:frame draw:style-name="fr1" draw:name="$filename" text:anchor-type="aschar" svg:width="{$width}cm" svg:height="{$height}cm" draw:z-index="{$index}"><draw:image xlink:href="Pictures/$file" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/></draw:frame>
IMG;
    ...
    private function _parse()
    {
        ...
        // SUppression du dernier saut de page
        $this->contentXml = str_replace('<text:p text:style-name="P1"></text:p><text:p text:style-name="Standard"/>', '',  $this->contentXml);
