...
<div class="input-append pull-left">
    ...
    <div class="btn-group" id="search_bloc">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li>
                <a id="search_tree_plier_button" title="Replier tous les services">Tout replier</i></a>
            </li>
            <li>
                <a id="search_tree_deplier_button" title="Déplier tous les services">Tout déplier</a>
            </li>
        </ul>
    </div>
</div>
...
<div id="arbre">
    <?php
    echo $this->Tree->generateIndex($data, 'Service', array('id' => 'id', 'display' => 'libelle', 'order' => 'order'));
    ?>
</div>
